...
Affecteds <- c("FE", "DCL", "GC", "II", "LM", "MC", "MM", "PO", "RB", "SG")
...
dataset <- read.csv(file = "/Users/randersondouglas/Desktop/Mestrado PPGMCC 2017:2/3 Exploração e mineração de dados/Trabalhos/3 - Trabalho/Vulnerability_Dataset/unbalanced/glibc_data.csv", stringsAsFactors = FALSE)
...
results <- rbind(results, partial_results[,5])
